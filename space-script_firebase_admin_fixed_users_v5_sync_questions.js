...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const controls = navbar ? navbar.querySelector('.nav-controls') : null;

    if (!navbar || !toggleBtn || !controls) return;
    ...
    // لو رجعنا لشاشة كبيرة: قفل القائمة
    window.addEventListener('resize', () => {
